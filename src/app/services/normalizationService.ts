import { TitleFlavor, Track } from "../types";
...
function normalizeTrackPresentation(title: string, artist: string) {
...
function getDurationBucket(durationSeconds: number, sizeSeconds = 2) {
...
export function normalizeTrackForCanonicalization(track: Track) {
...
export const normalizationService = {
  ...
  normalizeComparisonText(value: string) {
